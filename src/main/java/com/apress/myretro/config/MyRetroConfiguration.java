    ...
    ApplicationListener<ApplicationReadyEvent> ready(RetroBoardService retroBoardService) {
        return applicationReadyEvent -> {
            ...
            retroBoardService.save(RetroBoard.builder()
                    ...
                    .card(Card.builder().id(UUID.fromString("bb2a80a5-a0f5-4180-a6dc-80c84bc014c9"))
                            .comment("Spring Boot Rocks!")
                            .cardType(CardType.HAPPY)
                            .build())
                    .card(Card.builder().id(UUID.randomUUID())
                            .comment("Meet everyone in person")
                            .cardType(CardType.HAPPY)
                            .build())
                    .card(Card.builder().id(UUID.fromString("775a3905-d6be-49ab-a3c4-ebe287b51539"))
